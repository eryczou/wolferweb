 ...
 */
exports.getTwoRandom = function(req, res, next) {
 ...
 */
exports.getTopContent = function(req, res, next) {
 ...
 */
exports.getShameContent = function(req, res, next) {
  Character
    .find()
    .sort('-losses')
    .limit(100)
